...
#endif
/* Tokens.  */
#define PARAPERTA_T 258
#define PARCHIUSA_T 259
#define PARAPERTA_Q 260
#define PARCHIUSA_Q 261
#define PV 262
#define EPS 263
#define PIPE 264
#define PUO_ESSERE 265
#define NUM_LOOKAHEAD 266
#define OP_LOOKAHEAD 267
#define NON_TERM 268
#define TERM 269
...
{
  "$end", "error", "$undefined", "PARAPERTA_T", "PARCHIUSA_T",
  "PARAPERTA_Q", "PARCHIUSA_Q", "PV", "EPS", "PIPE", "PUO_ESSERE",
  "NUM_LOOKAHEAD", "OP_LOOKAHEAD", "NON_TERM", "TERM", "$accept",
  "grammatica", "regole", "regola", "corpo", "elementi", "elemento", YY_NULLPTR
};
#endif
...
{
      -1,     1,    -8,     6,   -17,    -1,     2,    -5,   -17,   -17,
      10,    -5,   -17,   -17,   -17,     8,     7,    -5,     4,    12,
     -17,    -5,   -17,     9,   -17,   -17,    -5,    13,   -17
};
...
{
      11,    19,     7,    12,     6,    25,     8,    22,    13,    14,
      27,     1,     2,    10,    18,    20,    21,    23,    24,    26,
      28,     9
};

static const yytype_uint8 yycheck[] =
{
       5,    11,    10,     8,     3,    21,     0,    17,    13,    14,
      26,    12,    13,    11,     4,     7,     9,    13,     6,    10,
       7,     5
};
...
{
       0,    12,    13,    16,    17,    18,     3,    10,     0,    17,
      11,     5,     8,    13,    14,    19,    20,    21,     4,    20,
       7,     9,    20,    13,     6,    19,    10,    19,     7
};
